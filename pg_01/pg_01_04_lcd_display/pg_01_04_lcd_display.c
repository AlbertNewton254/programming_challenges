...
/* Enum representing each of the 7 segments in a digit */
typedef enum {
    SEG_TOP = 0,
    SEG_TOP_LEFT,
    SEG_TOP_RIGHT,
 ...
 * @param seg The segment to print (top, middle, or bottom).
 */
 ...
 * @param digit The digit to display (0–9).
 * @param s The scale factor.
 * @param left_seg Segment for the left side.
 * @param right_seg Segment for the right side.
 */
 ...
 *
 * @param number A string of digits to display.
 * @param s The scale factor (1–10).
 */
 ...
 *
 * Prompts the user for a scale and a number, then prints the LCD-style output.
 *
